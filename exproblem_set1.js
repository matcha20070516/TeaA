...
// 新規開始時刻を記録
startTime = Date.now();
localStorage.setItem(SET_PREFIX + “StartTime”, startTime);
} else {
// 保存された開始時刻を取得
...
// 経過時間を保存（結果画面用）
localStorage.setItem(SET_PREFIX + “ElapsedTime”, elapsedSec);
};
...
localStorage.getItem(SET_PREFIX + “Username”) ||
“名無し”;
...
localStorage.setItem(SET_PREFIX + “Score”, score);
localStorage.setItem(SET_PREFIX + “Answers”, JSON.stringify(answers));
