...
window.onload = () => {
  ...
  for (let i = 0; i < correctAnswers.length; i++) {
    ...
    if (!isCorrect) tr.classList.add("incorrect");
  ...
  resultSummary.textContent = `正解数：${correctCount} / ${correctAnswers.length} 問, 合計得点：${totalScore} 点`;
};
</script>
  ...
  <script src="exresult_detail.js"></script>
</body>
</html>
